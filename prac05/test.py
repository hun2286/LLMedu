...
def rag_answer(question):
    ...
    messages = [
        SystemMessage(content="""
            ...
            - 각 항목별로 반드시 다음 순서를 지켜서 작성하세요:
            항목 내용
            [출처: 해당 PDF 이름]
            - 각 항목과 출처 사이에 반드시 한 줄 개행을 넣으세요.
            - 출처를 임의로 추측하지 말고, 문서 내용에서 확인된 출처만 사용하세요.
            """),
...
def append_to_pdf(question, answer):
    ...
    for line in lines:
        ...
        if not line:
            continue
        if line.startswith("(출처:") or line.startswith("[출처:"):
