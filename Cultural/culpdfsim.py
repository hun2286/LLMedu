...
def rag_answer(question):
    ...
    # used_sources = []
    # for doc in retriever_docs:
    #     if any(k in doc.page_content for k in question.split()):
    #         used_sources.append(doc.metadata.get("source", "출처 없음"))

    # # 중복 제거 + 최대 4개
    # sources = list(dict.fromkeys(used_sources))[:4]
